// Simple cleanup script - you'll need to provide your GitHub token
// Run this with: GITHUB_TOKEN=your_token GITHUB_USERNAME=your_username node cleanup-simple.js
...
async function cleanupRepositories() {
  if (!GITHUB_TOKEN || !GITHUB_USERNAME) {
    ...
    console.error('');
    console.error('To run this script, you need to provide:');
    console.error('1. Your GitHub Personal Access Token');
    console.error('2. Your GitHub username');
    console.error('');
    console.error('Run it like this:');
    console.error('GITHUB_TOKEN=your_token_here GITHUB_USERNAME=your_username node cleanup-simple.js');
    console.error('');
    console.error('Or set the environment variables:');
    console.error('export GITHUB_TOKEN=your_token_here');
    console.error('export GITHUB_USERNAME=your_username');
    console.error('node cleanup-simple.js');
    process.exit(1);
  }
