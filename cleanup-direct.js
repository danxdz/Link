...
// Run with: GITHUB_TOKEN=your_token GITHUB_USERNAME=your_username node cleanup-direct.js
...
async function cleanupRepositories() {
  if (!GITHUB_TOKEN || !GITHUB_USERNAME) {
    ...
    console.error('GITHUB_TOKEN=your_token_here GITHUB_USERNAME=your_username node cleanup-direct.js');
    console.error('');
    console.error('Or set the environment variables:');
    console.error('export GITHUB_TOKEN=your_token_here');
    console.error('export GITHUB_USERNAME=your_username');
    console.error('node cleanup-direct.js');
    process.exit(1);
  }
